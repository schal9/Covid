 ...
 <div class="divv" >
  <form action="insert.php" method="POST">
    <center>
      ...
      <tr>
        <th>Hospital Name</th>
        <td><input type="text" name="Hospitals" placeholder="Hospital Name" required></td>
      </tr>
      ...
      <tr>
        <th>Enter Contact</th>
        <td><input type="text" name="Contact" placeholder="Enter 10-digit number" required></td>
      </tr>

      <tr>
        <th>Total Available Beds</th>
        <td><input type="number" name="beds" required></td>
      </tr>

      <tr>
        <th>Total Oxygen Bed</th>
        <td><input type="number" name="totalO2" required></td>
      </tr>

      <tr>
        <th>Vacant Oxygen Bed</th>
        <td><input type="number" name="vacantO2" required></td>
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" name="vacant" required></td>
      </tr>

      <tr>
        <th>Doctors/Incharge</th>
        <td><input type="text" name="doctors" required></td>
      </tr>
