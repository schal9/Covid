...
<?php
//connection
    $conn = mysqli_connect("localhost","root","","covid_db") or die ("Connection Failed");
    if (isset($_POST['sub'])) {
      ...
      if(!$count)
      {
        ...
        header("Location:Availability.php?error=Invalid Username");
      }
      else{
...
<div id="id01" class="modal">
  ...
  <form method="POST" class="modal-content animate">
    ...
    <div class="container">
      ...
      <button type="submit" name="sub">Login For Data Entry</button><br>
...
<!-- ========= Bed Details ======== -->
  ...
  <div class="container-fluid">
        ...
        <table class="table table-bordered table-primary table-responsive">
          ...
          <tr>
            ...
            <th colspan="2" scope="col" class="text-center col-md-2" >Ventilator Bed</th>
             ...
             <!-- <th rowspan="2" scope="col" class="text-center name" style="padding-bottom: 25px;">Update/Edit</th>
            </tr>-->
          <tr>
    ...
    <tr style="text-align: center;">
      ...
      <!--<td><a  class="btn btn-outline-primary" href="update.php?rn=$result[id]">Update</a></td>-->
